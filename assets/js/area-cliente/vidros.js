$(document).ready(function() {
            ...
            success: function(response) {
                if (response=="0"){
                    ...
                    if (vetor[5]=="1"){
                        ...
                        $("#Enviar").val("ENVIAR AVISO DE SINISTRO");
                        $("#etapa4").remove();
                        $(".tituloanexos").remove();
    ...
    $(".campo").keyup(function(){
        if ($(this).val().split("_").join("").split(".").join("").split("/").join("").split("-").join("").split("(").join("").split(")").join("").split(" ").join("")!="" && $(this).attr("name") != "CNPJEmpresa"){
            $(this).parent().next().slideDown();
        }
    });
    ...
    $(".form-sinistro").on("submit", function(e) {
        ...
        pro.then(()=>{
            ...
            var link = base_url + '/area-cliente/vidros/send';
            $.ajax({
                type: 'POST',
                url: link,
                data: formdata,
