$(document).ready(function() {
    ...
    $(document).ready(function () {
        ...
        //plano,nomePlano,valorPlano,botaoContratar
        $("#plano").change(function(){
            if ($(this).val()!=""){
                $("#nomePlano").html("Plano " + $(this).val());
                //Básico,Completo,Plus
                if ($(this).val()=="Essencial"){
                    $("#valorPlano").val("R$ 34,90/mês");
                }else if ($(this).val()=="Plus"){
                    $("#valorPlano").val("R$ 44,90/mês");
                }else if ($(this).val()=="Master"){
                    $("#valorPlano").val("R$ 54,90/mês");
                }
                $("#botaoContratar").slideDown();
            }else{
                $("#botaoContratar, #infoPlano").slideUp();
            }
        });
    });
