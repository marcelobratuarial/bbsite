<div class="pt-0">
    <section class="background-11">
            <div class="container">
                <div class="row mt-6">
                    <div class="col-12">
                        <h3 class="text-center fs-2 fs-md-3">Bike</h3>
                ...
                <div class="row mt-5">
                    ...
                    <div class="col-lg-6 d-flex flex-column">
                        ...
                        <ul>
                            <li>Montagem da Bike</li>
                            <li>Quebra de Corrente</li>
                            <li>Pneu Avariado</li>
                            <li>Falta de Freios</li>
                            <li>Remoção Médica Intra-Hospitalar</li>
                            <li>Transporte Dentro do Município</li>
                        </ul>
                    ...
                    <div class="col-lg-6 d-flex flex-column align-items-center">
                        ...
                        <img class="my-5" width="90%" src="assets/svg/bike_hero.svg" alt="">
