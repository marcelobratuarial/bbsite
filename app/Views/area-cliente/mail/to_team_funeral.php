...
<head>
  ...
  <title>AVISO DE ACIONAMENTO FUNERAL</title>
...
<table width="600" border="0" cellpadding="0" cellspacing="0" class="force-row" style="width: 600px;">
  ...
  <tr>
    <td class="content-wrapper" style="font-family:Segoe UI, Helvetica, Arial, sans-serif;padding-left:24px;padding-right:24px;text-align: left;">
      <p style="text-transform:uppercase;font-size: 24px !important;margin-top: 15px; margin-bottom: 15px;">AVISO DE ACIONAMENTO FUNERAL</p> 
