...
<?= $this->section('content') ?>
            ...
            <div class="container mt-8">
                <div class="row mb-6 mt-6">
                    <div class="col-12">
                        <h3 class="text-center fs-2 fs-md-3">Funeral</h3>
...
<link href="<?= base_url("assets/css/area-cliente/funeral.css") ?>" rel="stylesheet">
<?= $this->endSection() ?>

<?= $this->section('cScripts') ?>
<!-- Carro Reserva Scripts -->
<script type="text/javascript" src="<?= base_url("assets/js/area-cliente/funeral.js") ."?".time() ?>"></script>
<?= $this->endSection() ?>