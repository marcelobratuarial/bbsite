            ...
            <div class="container">
                ...
                <div class="row mt-5">
                    ...
                    <div class="col-lg-6 d-flex flex-column justify-content-center">
                        <img width="80%" src="assets/svg/carroreserva_hero.svg" alt="">
                    </div>
                ...
                <div class="row mt-5">
                    <a style="width: 260px" class="mx-auto btn btn-primary mt-3 fs-1" href="<?= base_url("/area-cliente/carro-reserva") ?>">Solicite agora
