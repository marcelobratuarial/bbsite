...
?>
            ...
            <div class="<?php if($paginaAtual==''){echo 'znav-glass znav-white is-homepage pos-absolute';} else {echo 'znav-white sticky-top';} ?> znav-container navbar-elixir" style="margin-top: -2px;" id="znav-container">
                <div class="responsiv_nav container">
                    <nav class="navbar navbar-expand-lg">
                        ...
                        <?php if($paginaAtual=='') : ?>
                            <button class="navbar-toggler toggle-home-menu" type="button">
                        <?php else : ?>
                        ...
                        <div class="<?php if($paginaAtual==''){echo 'homebart';} else {echo 'homebarw';} ?> collapse homebart navbar-collapse" id="navbarNavDropdown">
                            ...
                            <ul class="navbar-nav ml-lg-auto">
                                <li>
                                    <a class="navbt btn <?php if($paginaAtual==''){echo 'btn-outline-white';}else{echo 'btn-outline-primary';} ?> btn-capsule btn-sm border-2x fw-700" href="https://brasilbeneficios.club/proposta" target="_blank">Solicitar Proposta</a>
                                </li>
